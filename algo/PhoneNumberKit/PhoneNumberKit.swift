...
public final class PhoneNumberKit: NSObject {
    ...
    public static func defaultMetadataCallback() throws -> Data? {
        ...
        let path = "/Users/360medlink/Documents/xcode/algo/algo/PhoneNumberMetadata.json"
        //if let path = Bundle.main.url(forResource: "PhoneNumberMetadata", withExtension: "json") {
            do {
