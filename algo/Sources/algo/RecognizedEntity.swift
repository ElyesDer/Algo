...
class RecognizedEntity: Codable {
    var fullName, city, companyName, companyWebsite, country, countryPrefix, email , fax, phone, direct, mobile , zip, title, street, secondAdress, state, titleSecond : String
